...
export const bdlBorderRadiusMedSize = '6px'; // bdl-border-radius-med-size
export const bdlBorderRadiusLargeSize = '8px'; // bdl-border-radius-large-size
export const bdlBorderRadiusXlargeSize = '12px'; // bdl-border-radius-xlarge-size
