...
const Certificate56 = (props: SVGProps): JSX.Element => (
    <AccessibleSVG width={56} height={56} viewBox="0 0 56 56" {...props}>
        <g fill="none" fillRule="evenodd">
            ...
            />
            <path fill={vars.bdlBoxBlue10} fillRule="nonzero" d="M36 27a6 6 0 100 12 6 6 0 000-12z" />
            <rect width={4} height={4} x={34} y={31} fill={vars.bdlBoxBlue} rx={2} />
        </g>
    </AccessibleSVG>
);
