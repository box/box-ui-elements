...
const findMissingProperties = (obj?: Object, properties: Array<string> = []): Array<string> => {
...
const fillMissingProperties = (obj: Object = {}, properties?: Array<string>): Object => {
    // If file doesn't exist or is an empty object, we should fetch all fields
...
/** Fill user properties that are null in an object with the placeholder user. */
const fillUserPlaceholder = (obj: Object): Object => {
    const newObj = { ...obj };
