 ...
 */
// TODO: restore KeyboardEvent | React.KeyboardEvent once DOM types include Safari keyIdentifier
// and callers/tests pass real events. Structural type is the fields decode actually reads;
// the original union omitted keyIdentifier (needed $FlowFixMe) and rejected partial event objects.
