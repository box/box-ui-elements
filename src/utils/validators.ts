...
const hostnameValidator = (value: string): boolean => {
...
const ipv4AddressValidator = (value: string): boolean => {
    // @see https://www.oreilly.com/library/view/regular-expressions-cookbook/9780596802837/ch07s16.html
    const regex = /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/;
    return regex.test(value);
};

const domainNameValidator = (value: string): boolean => Address.domain.isValid(value);
