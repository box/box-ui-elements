 ...
 */
export function isActivateKey(event: React.KeyboardEvent): boolean {
 ...
 */
export function isLeftClick(event: React.MouseEvent): boolean {
 ...
 */
export function focus(root?: HTMLElement | null, selector?: string, focusRoot: boolean = true): void {
    if (!root) {
        return;
    }
 ...
 */
export function scrollIntoView(itemEl?: HTMLElement | null, options: object = {}): void {
