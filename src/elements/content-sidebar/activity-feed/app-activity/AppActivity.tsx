...
interface AppActivityProps {
    ...
    intl: IntlShape;
    isPending?: boolean;
    onDelete: ({ id, permissions }: { id: string; permissions?: BoxItemPermission }) => void;
...
function mapActivityNodes(node: HTMLLinkElement): React.ReactNode {
...
class AppActivity extends React.PureComponent<AppActivityProps, State> {
    static defaultProps = {
        onDelete: noop,
        permissions: {},
    };
            ...
            >
                ...
                >
                    ...
                    <Media.Body className="bcs-AppActivity-body">
                        {isMenuVisible && (
                            <TetherComponent
                                // @ts-ignore: Tether component props are not properly typed
