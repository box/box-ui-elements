...
import { BaseCommentMenu, BaseCommentMenuProps } from '../BaseCommentMenu';
import { baseCommmentMenuDefaultProps } from './common';

const getTemplate = (customProps?: Partial<BaseCommentMenuProps>) => (props: Partial<BaseCommentMenuProps>) => (
