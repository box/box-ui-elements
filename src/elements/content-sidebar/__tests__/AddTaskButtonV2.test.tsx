...
import { AddTaskButtonV2Component as AddTaskButtonV2 } from '../AddTaskButtonV2';
import type { AddTaskButtonV2Props as Props } from '../AddTaskButtonV2';
import { ViewType, FeedEntryType } from '../../common/types/SidebarNavigation';

jest.mock('../AddTaskMenuV2', () => ({ onMenuItemClick, isDisabled, setAddTaskButtonRef }) => (
    <div data-testid="add-task-menu-v2">
        <button
            type="button"
...
describe('elements/content-sidebar/AddTaskButtonV2', () => {
    /*
    ...
    */
    ...
    const defaultProps = {
        history: { replace: jest.fn() } as unknown as History,
        isDisabled: false,
    ...
    const renderComponent = (props: Partial<Props> = {}) => {
        return render(<AddTaskButtonV2 {...defaultProps} {...props} />);
    };
    ...
    test('should call history.replace state with force open state when task menu items are clicked', async () => {
        const historyMock = { replace: jest.fn() } as unknown as History<unknown>;
