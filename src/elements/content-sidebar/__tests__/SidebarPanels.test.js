...
describe('elements/content-sidebar/SidebarPanels', () => {
    ...
    describe('multiple customSidebarPanels rendering', () => {
        ...
        test('should render custom panels with regular panels', () => {
            ...
            const analyticsWrapper = getWrapper({
                path: '/analytics',
                customSidebarPanels,
                hasActivity: true,
                hasMetadata: true,
            ...
            expect(analyticsWrapper.find('div[data-testid="analytics-sidebar"]')).toHaveLength(1);

            const reportsWrapper = getWrapper({
                path: '/reports',
                customSidebarPanels,
                hasActivity: true,
                hasMetadata: true,
            ...
            expect(reportsWrapper.find('div[data-testid="reports-sidebar"]')).toHaveLength(1);
        });
