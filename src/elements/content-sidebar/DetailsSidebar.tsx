...
interface ExternalProps extends ErrorContextProps, WithLoggerProps {
    ...
    onClassificationClick?: (e: React.MouseEvent<HTMLButtonElement>) => void;
...
interface State {
    ...
    accessStatsError?: ElementsXhrError;
    file?: BoxItem;
    fileError?: ElementsXhrError;
