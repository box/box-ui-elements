...
class ContentPicker extends Component<Props, State> {
    ...
    private table: any = null; // Table from react-virtualized has complex typing

    private rootElement: HTMLElement | null = null;

    private appElement: HTMLElement | null = null;

    private globalModifier: boolean = false;

    private firstLoad: boolean = true; // Keeps track of very 1st load
     ...
     * @return {void}
     */
    fetchFolder = (id?: string, triggerNavigationEvent = true): void => {
     ...
     * @return {void}
     */
    debouncedSearch = debounce((id: string, query: string): void => {
     ...
     * @return {void}
     */
    tableRef = (table: React.Component | null) => {
        this.table = table;
    };
