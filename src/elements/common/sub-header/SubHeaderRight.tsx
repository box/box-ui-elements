...
const SubHeaderRight = ({
    ...
    const isMetadataViewV2 = useFeatureEnabled('contentExplorer.metadataViewV2');
    ...
    const isMetadataView: boolean = viewMode === VIEW_METADATA;
    return (
        <div className="be-sub-header-right">
            ...
            {isMetadataView && isMetadataViewV2 && (
