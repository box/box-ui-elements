...
describe('elements/common/item/IconCell', () => {
    ...
    describe('render()', () => {
        ...
        test('should render archive icon', () => {
            ...
            expect(wrapper.name()).toBe('SvgArchive');
            expect(wrapper.prop('aria-label')).toBe('Archive');
        });
        ...
        test('should render archived folder icon', () => {
            ...
            expect(wrapper.name()).toBe('SvgFolderArchive');
            expect(wrapper.prop('aria-label')).toBe('Archived Folder');
        });
