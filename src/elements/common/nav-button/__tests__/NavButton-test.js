...
describe('elements/common/nav-button/NavButton', () => {
    ...
    describe('onKeyPress', () => {
        ...
        it('calls onKeyPress eventhandler and history.push', () => {
            const keyPressHandler = jest.fn();

            const button = mount(
                <Router history={mockHistory}>
                    <NavButton to="/activity/test" onKeyPress={keyPressHandler}>
                        Activity Test
                    </NavButton>
                </Router>,
            );
        ...
        it('does not call history.push on non-enter keypress', () => {
            const button = mount(
                <Router history={mockHistory}>
                    <NavButton to="/activity/test">Activity Test</NavButton>
                </Router>,
