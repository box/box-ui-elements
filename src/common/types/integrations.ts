...
type ExecuteAPI = {
    ...
    params: Array<ExecuteAPIParam> | null | undefined;
    url: string;
};
...
type DisabledReason =
    | string
    | React.ReactElement<React.ComponentProps<typeof FormattedMessage>>
    | React.ReactElement<React.ComponentProps<typeof BoxToolsInstallMessage>>;
