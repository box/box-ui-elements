...
type Token = null | undefined | string | ((...args: any[]) => any);
type TokenReadWrite = {
    read: string;
    write?: string;
};
...
type ClassComponent<P, S> = new (...args: any[]) => React.Component<P, S>;
...
type SelectorItems<T = any> = Array<SelectorItem<T>>;
...
type BoxItemVersion = {
    ...
    modified_at?: string;
    modified_by: User | null | undefined;
    name?: string;
    ...
    size?: number;
    start?: any;
    trashed_at: string | null | undefined;
