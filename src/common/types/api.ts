...
type ErrorContextProps = {
    onError: (error: ElementsXhrError | Error, code: string, contextInfo?: any, origin?: ElementOrigin) => void;
};

type ElementsErrorCallback = (e: ElementsXhrError, code: string, contextInfo?: any) => void;
