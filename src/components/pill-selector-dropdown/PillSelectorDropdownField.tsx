...
import PillSelectorDropdown, { type PillSelectorDropdownProps } from './PillSelectorDropdown';
...
export interface PillSelectorDropdownFieldProps extends FieldProps {
    ...
    onInput?: PillSelectorDropdownProps['onInput'];
...
> {
    ...
    handleBlur = (
        event?:
            | Parameters<PillSelectorDropdownProps['onInput']>[1]
            | Parameters<NonNullable<PillSelectorDropdownProps['onBlur']>>[0],
    ) => {
    ...
    handleInput: PillSelectorDropdownProps['onInput'] = (text, event) => {
