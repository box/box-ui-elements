...
const IconFilePresentation = ({ className = '', width = 32, height = 32 }: IconType) =>
    <svg className={className} width={width} height={height} viewBox='0 0 32 32' role='img'>
        ...
        <polygon fill='#F79420' points='9.9,22.4 9.1,21.6 14,16.8 16.5,19.3 22.1,13.6 22.9,14.4 16.5,20.7 14,18.2' />
    </svg>;
