...
export interface BreadcrumbProps {
    ...
    /** Internationalization object used to format the accessible label */
    intl: IntlShape;
    ...
    overflowMenuButton?: React.ReactElement;
...
const Breadcrumb = ({
    ...
    const breadcrumbs = React.Children.toArray(children) as React.ReactElement[];
