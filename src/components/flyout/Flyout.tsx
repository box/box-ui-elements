 ...
 * @returns {boolean}
 */
const hasClickableAncestor = (rootNode: Node | null, targetNode: EventTarget | null) => {
    // Check if the element or any of the ancestors are click-able (stopping at the component boundary)
    let currentNode: Node | null = targetNode instanceof Node ? targetNode : null;
 ...
 */
const hasClassAncestor = (targetEl: EventTarget | null, className: string) => {
    let el: Node | null = targetEl instanceof Node ? targetEl : null;
...
export interface FlyoutProps {
    /** Button and overlay elements */
    children: React.ReactNode;
    /** Set className to the overlay wrapper */
    className?: string;
    /** If set to true, closes the overlay on clicking buttons/links inside of it */
    ...
    closeOnClickPredicate?: (event: React.SyntheticEvent) => boolean;
...
class Flyout extends React.Component<FlyoutProps, FlyoutState> {
    ...
    componentDidUpdate(prevProps: FlyoutProps, prevState: FlyoutState) {
    ...
    handleOverlayClick = (event: React.SyntheticEvent) => {
    ...
    handleButtonClick = (event: React.UIEvent) => {
    ...
    hoverDelay: ReturnType<typeof setTimeout> | undefined;
    ...
    render() {
        ...
        const overlayButtonProps: Record<string, unknown> = {
        ...
        const tetherProps: Record<string, unknown> = {
