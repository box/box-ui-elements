...
class DraftJSMentionSelector extends React.Component<DraftJSMentionSelectorProps, DraftJSMentionSelectorState> {
    ...
    static getDerivedStateFromProps(nextProps: DraftJSMentionSelectorProps) {
    ...
    componentDidUpdate(prevProps: DraftJSMentionSelectorProps, prevState: DraftJSMentionSelectorState) {
    ...
    toggleTimestamp = (editorState?: EditorState | null, forceOn: boolean = false) => {
