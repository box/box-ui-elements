...
import { type CollabRestrictionType, type SuggestedCollabLookup, type contactType as Contact, type USMConfig } from './flowTypes';
...
interface Props {
    ...
    config?: USMConfig;
    contactLimit?: number;
    contactsFieldAvatars?: React.ReactNode;
    contactsFieldDisabledTooltip: React.ReactNode;
    contactsFieldLabel: React.ReactNode;
    ...
    onContactAdd?: (contacts: Array<Contact>) => void;
    ...
    openInviteCollaboratorsSection?: () => void;
    ...
    updateSelectedContacts: (contacts: Array<Contact>) => void;
}
...
interface State {
    ...
    message: string;
    selectedJustificationReason: SelectOptionProp | null;
}
...
class EmailForm extends React.Component<Props, State> {
    ...
    contactsFieldRef = React.createRef<PillSelectorDropdown>();
    ...
    handleContactRemove = (option: Contact | SelectOptionProp, index: number) => {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                {isExpanded && (
                    <ModalActions>
                        <ButtonAdapter isDisabled={submitting} onClick={this.handleClose} type={ButtonType.BUTTON} {...cancelButtonProps}>
...
export default injectIntl(EmailForm) as React.ComponentType<Omit<Props, 'intl'>>;
