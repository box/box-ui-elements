...
const MOCK_COLLAB_REQUEST_USERS_ONLY = {
    emails: MOCK_EMAIL_STRING,
    groupIDs: '',
    permission: 'Editor',
};

const MOCK_COLLAB_REQUEST_GROUPS_ONLY = {
    emails: '',
    groupIDs: MOCK_GROUPID_STRING,
    permission: 'Editor',
};

const MOCK_COLLAB_REQUEST_USERS_AND_GROUPS = {
    emails: MOCK_EMAIL_STRING,
    groupIDs: MOCK_GROUPID_STRING,
    permission: 'Editor',
};

const MOCK_COLLAB_REQUEST_USERS_ARRAY = [
    {
        accessible_by: {
...
const MOCK_COLLAB_REQUEST_GROUPS_ARRAY = [
    {
        accessible_by: {
            id: '12345',
            type: 'group',
...
const MOCK_COLLABS_CONVERTED_REQUEST = {
    groups: MOCK_COLLAB_REQUEST_GROUPS_ARRAY,
    users: MOCK_COLLAB_REQUEST_USERS_ARRAY,
};
