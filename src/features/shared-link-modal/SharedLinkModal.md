...
const contacts = [
    ...
    { id: 8, name: 'Wenbo', email: 'wyu@box.com', type: 'user' },
    {
        ...
        email: 'Supersupersupersuperreallyreallyreallyincrediblyspectacularlylongemail@box.com',
        type: 'user',
    },
];
...
<div>
    {state.isOpen && (
        <SharedLinkModal
            ...
            canRemoveLink
            changeAccessLevel={newLevel => fakeRequest().then(() => setState({ accessLevel: newLevel }))}
            changePermissionLevel={newLevel => fakeRequest().then(() => setState({ permissionLevel: newLevel }))}
