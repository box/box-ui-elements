...
const DropCloud = ({ className, cloudSize = 64, intl, position }) => {
    const { x, y } = position;
    return (
        <div className={classNames('drop-cloud', className)} style={{ top: `${y}px`, left: `${x}px` }}>
            <IconCloud
...
// Actual export
export { DropCloud as DropCloudBase };
export default injectIntl(DropCloud);
