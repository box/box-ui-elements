 ...
 * @returns {Promise} Promise that proxies the promise of the passed function.
 */

function retryNumOfTimes(func: Function, times: number, initialTimeout?: number = 0, backoffFactor?: number = 1) {
    let tries = 0;
