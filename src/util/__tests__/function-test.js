...
describe('util/function', () => {
    ...
    describe('retryNumOfTimes()', () => {
        it('should create a promise that resolves when the wrapped promise resolves', () => {
        ...
        it('should create a promise that resolves when the wrapped promise resolves on the second try', () => {
            let times = 0;
        ...
        it('should create a promise that rejects when the wrapped promise fails after the second try', () => {
        ...
        it('should create a promise that does not retry when the wrapped promise hardRejects', () => {
            const inner = sandbox.spy();
