...
const IconTaskApproval = ({ className = '', color = '#F5B31B', height = 30, title, width = 30 }: Props) => (
    <AccessibleSVG className={className} height={height} title={title} viewBox="0 0 20 20" width={width}>
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g transform="translate(1.000000, 1.000000)" fillRule="nonzero">
                <circle stroke="#FFFFFF" fill={color} cx="9" cy="9" r="9.5" />
                <g transform="translate(4.500000, 3.000000)" fill="#FFFFFF">
