...
const IconComposeNote = ({ className = '', color = '#777', height = 16, title, width = 16 }: Props) => (
    <AccessibleSVG
        ...
        viewBox="0 0 16 16"
    >
        <path className="fill-color" fill={color} d="M0 1h10l-.7 1H0z" />
        <path className="fill-color" fill={color} d="M0 5h7.7L7 6H0z" />
        <path className="fill-color" fill={color} d="M0 9h5l-.6 1H0z" />
        <path
