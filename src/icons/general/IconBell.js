...
const IconBell = ({ className = '', color = '#FFFFFF', height = 20, title, width = 20 }: Props) => (
    <AccessibleSVG className={`icon-bell ${className}`} title={title} width={width} height={height} viewBox="0 0 20 20">
        <g transform="matrix(1 0 0 -1 1 19)" fill="none" fillRule="evenodd">
            ...
            />
            <circle className="stroke-color" stroke={color} cx="9" cy="5" r="1" />
        </g>
    </AccessibleSVG>
);
