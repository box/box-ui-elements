...
const IconSettingInverted = ({ className = '', color = '#444444', height = 16, title, width = 16 }: Props) => (
    <AccessibleSVG
        className={`icon-setting-inverted ${className}`}
        height={height}
        title={title}
        viewBox="0 0 16 16"
        width={width}
