        ...
        <g fill="none" fillRule="evenodd">
            ...
            <g transform="translate(55 27)">
                <rect
                    ...
                    rx="3.6"
                />
                <circle className="stroke-color" stroke={color} strokeWidth="1.8" cx="33" cy="99" r="5" />
                <path
                    className="stroke-color"
                    stroke={color}
                    strokeWidth="2"
                ...
                <path
                    ...
                    strokeLinejoin="round"
                />
                <circle className="fill-color" fill={color} cx="33" cy="8" r="2" />
                <ellipse className="fill-color" fill={color} fillOpacity=".1" cx="32.5" cy="125" rx="32.5" ry="3" />
            </g>
