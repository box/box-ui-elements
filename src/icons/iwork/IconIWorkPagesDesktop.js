    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <path fill="#9b9b9b" d="M.86 10.72L62.76.87l12 75.47-61.9 9.81z" />
                <path
                    fill="#9b9b9b"
                ...
                />
                <path fill={`url(#${this.idPrefix}a)`} d="M1.28 11l11.88 74.73L74.37 76 62.46 1.28z" />
                <path
                    fill="#e2e2e2"
                ...
                />
                <path fill="#f27d09" d="M64.65 15L62.53 1.64l-61.2 9.74 2.12 13.36z" />
                <path fill={`url(#${this.idPrefix}b)`} d="M64.59 14.6L62.46 1.28 1.28 11l2.11 13.38z" />
                <path
                    fill="#ee8100"
                ...
                />
                <circle cx="45.24" cy="85.33" r=".61" fill={`url(#${this.idPrefix}c)`} />
                <path
                ...
                />
                <path fill="#b98421" d="M67.12 2.61s.36-.64 2.44-.55c0 0 3.41 0 4.32 2.8z" />
                <path
                ...
                />
                <path d="M45.91 84.49l-.39.81.11.1.51-.73z" className="q" />
                <path fill={`url(#${this.idPrefix}k)`} d="M10.43 28.26L38 23.86l3.22 20.33-27.52 4.33z" />
                <path fill="#f98905" d="M27.86 30s1-1.44 2.16-1.44c0 0 .68 0 .58 1z" />
                <path
                ...
                />
                <path fill="#522d2e" d="M25.4 43s-.13-.83 1.52-1.08a1.42 1.42 0 0 1 1.44.62z" />
                <path
