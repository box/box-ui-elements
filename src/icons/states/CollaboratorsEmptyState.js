...
const CollaboratorsEmptyState = ({ className = '', color = bdlBoxBlue, height = 64, title, width = 90 }: Props) => (
    <AccessibleSVG
    ...
    >
        <g fill="none" fillRule="evenodd">
            <path
                ...
                fill={color}
            />
            <g className="stroke-color" fill="#FFF" stroke={color} strokeWidth="2" transform="rotate(10 -10.18 64.766)">
                <rect height="45.889" rx="1.5" width="68.799" x=".069" y=".393" />
                <path d="M.914 45.102c-.558.61-.336 1.105.493 1.105h65.157c.83 0 1.043-.494.483-1.095L34.69 10.372c-.564-.606-1.472-.602-2.03.01L.913 45.1z" />
                <path d="M1.648 1.358C.983.86 1.124.456 1.944.456H67.74c.83 0 .962.405.298.902l-31.99 23.966c-.665.498-1.744.497-2.408 0L1.648 1.358z" />
            </g>
            <path
