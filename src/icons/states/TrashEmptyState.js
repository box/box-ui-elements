...
const TrashEmptyState = ({ className = '', color = BOX_BLUE, height = 150, title, width = 150 }: Props) => (
    <AccessibleSVG
        ...
        <g fill="none" fillRule="evenodd">
            ...
            <g transform="translate(48.444 38.083)">
                ...
                <rect
                    ...
                    rx="1.8"
                />
                <g className="stroke-color" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
