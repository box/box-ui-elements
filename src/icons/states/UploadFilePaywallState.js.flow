        ...
        <g fill="none" fillRule="evenodd">
            ...
            <g transform="rotate(10 -109.02 216.52)">
                ...
                <path
                    ...
                    strokeWidth="2"
                />
                <circle className="fill-color" cx="37" cy="41" fill={color} fillOpacity=".1" r="34" />
                <circle className="stroke-color" cx="37" cy="41" fill="#FFF" r="31" stroke={color} strokeWidth="2" />
                <path
                    className="fill-color"
