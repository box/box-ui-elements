...
const LocationErrorState = ({
    ...
    >
        <g fill="none" fillRule="evenodd">
            ...
            />
            <rect width="4" height="30" x="65.5" y="20" fill={white} stroke={color} strokeWidth="2" rx="1.5" />
            <path
                fill={white}
                stroke={color}
                strokeWidth="2"
            ...
            />
            <rect width="17" height="12" x="68.5" y="21.506" fill={white} stroke={color} strokeWidth="2" rx="1.5" />
        </g>
    </AccessibleSVG>
);
