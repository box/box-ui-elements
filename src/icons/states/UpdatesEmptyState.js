...
const UpdatesEmptyState = ({ className = '', color = bdlBoxBlue, height = 150, title, width = 150 }: Props) => (
    <AccessibleSVG
    ...
    >
        <g transform="translate(5 5)" fill="none" fillRule="evenodd">
            ...
            >
                <path d="M75 16H5c-2.76 0-5-1.8-5-4s2.23-4 5-4h70M13 16h70c2.76 0 5 1.8 5 4s-2.23 4-5 4H13M48 0h45c2.76 0 5 1.8 5 4s-2.23 4-5 4H23M10.25 22.5h3.5M10.25 26.5h3.5" />
                <rect fill="#FFF" x="13" y="21" width="9" height="7" rx="1.5" />
            </g>
            <path
                className="fill-color"
                ...
                fill={color}
            />
            <g transform="translate(38.5 29)">
                <g transform="rotate(8 -123.332 267.286)">
                    <path
                        className="stroke-color"
            ...
            <ellipse className="fill-color" fillOpacity=".1" fill={color} cx="70" cy="137" rx="32.5" ry="3" />
        </g>
    </AccessibleSVG>
);
