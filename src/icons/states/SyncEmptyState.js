...
const SyncEmptyState = ({ className = '', color = bdlBoxBlue, height = 150, title, width = 150 }: Props) => (
    <AccessibleSVG
    ...
    >
        <g fill="none" fillRule="evenodd">
            ...
            <g
                ...
                strokeWidth="2"
            >
                <path d="M129.85 50.38c.73-.1.76 0 .05.23L92.63 62.36c-.7.22-1.76.05-2.35-.38l-6.5-4.68c-.6-.44-.5-.87.24-.96l45.83-5.96z" />
                <path d="M129.9 50.6c.7-.22.77-.08.14.32l-36.3 22.9c-.63.38-1.2.1-1.3-.62l-1.12-9.28c-.1-.73.4-1.5 1.1-1.7l37.5-11.62z" />
                <path d="M129.97 50.76c.66-.3.7-.24.07.16L93.7 73.7c-.63.4-.92.15-.65-.52l2.12-5.4c.27-.7 1.03-1.5 1.68-1.8l33.12-15.22z" />
                <path d="M129.97 50.75c.66-.3.78-.13.25.4l-23.03 22.7c-.54.52-1.43.57-2 .12l-8.5-6.7c-.57-.46-.5-1.07.16-1.37l33.1-15.15z" />
            </g>
            <path
                className="stroke-color"
