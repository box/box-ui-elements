...
const ThumbnailCardExamples = () => {
    const icon = (
        ...
        >
            <AccessibleSVG width={32} height={32} viewBox="0 0 14 14">
                <path
                    color="#000000"
    ...
    return (
        <div>
            <div>
                ...
                <br />
                <ThumbnailCard title={title} thumbnail={thumbnail} />
            </div>
            <br />
            <div>
                <h1>Single Card Example With Icon and Subtitle</h1>
                <ThumbnailCard icon={icon} subtitle={subtitle} title={title} thumbnail={thumbnail} />
            </div>
            <br />
            <div>
