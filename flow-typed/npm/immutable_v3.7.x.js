...
declare module 'immutable' {
    ...
    declare class _Iterable<K, V, KI, II, SI> {
        ...
        groupBy<G>(grouper: (value: V, key: K, iter: this) => G, context?: any): KeyedSeq<G, this>;
        ...
        filter(predicate: (value: V, key: K, iter: this) => mixed, context?: any): this;

        filterNot(predicate: (value: V, key: K, iter: this) => mixed, context?: any): this;
        ...
        find<V_>(predicate: (value: V, key: K, iter: this) => mixed, context: any, notSetValue: V_): V | V_;

        findLast(predicate: (value: V, key: K, iter: this) => mixed, context?: any): ?V;
        findLast<V_>(predicate: (value: V, key: K, iter: this) => mixed, context: any, notSetValue: V_): V | V_;
    ...
    declare class KeyedIterable<K, V> extends Iterable<K, V> {
        ...
        mapKeys<K_>(mapper: (key: K, value: V, iter: this) => K_, context?: any): /*this*/ KeyedIterable<K_, V>;
        ...
        map<V_>(mapper: (value: V, key: K, iter: this) => V_, context?: any): /*this*/ KeyedIterable<K, V_>;
    ...
    declare class IndexedIterable<T> extends Iterable<number, T> {
        ...
        zip<A, B>(a: ESIterable<A>, b: ESIterable<B>, $?: null): IndexedIterable<[T, A, B]>;
        zip<A, B, C>(a: ESIterable<A>, b: ESIterable<B>, c: ESIterable<C>, $?: null): IndexedIterable<[T, A, B, C]>;
        zip<A, B, C, D>(
            a: ESIterable<A>,
            b: ESIterable<B>,
            c: ESIterable<C>,
        ...
        zipWith<A, R>(zipper: (value: T, a: A) => R, a: ESIterable<A>, $?: null): IndexedIterable<R>;
        zipWith<A, B, R>(
        ...
        findIndex(predicate: (value: T, index: number, iter: this) => mixed, context?: any): number;
        findLastIndex(predicate: (value: T, index: number, iter: this) => mixed, context?: any): number;

        concat(...iters: ESIterable<T>[]): this;

        map<U>(mapper: (value: T, index: number, iter: this) => U, context?: any): /*this*/ IndexedIterable<U>;
    ...
    declare class SetIterable<T> extends Iterable<T, T> {
        ...
        map<U>(mapper: (value: T, value: T, iter: this) => U, context?: any): /*this*/ SetIterable<U>;

        flatMap<U>(mapper: (value: T, value: T, iter: this) => ESIterable<U>, context?: any): /*this*/ SetIterable<U>;
    ...
    declare class List<T> extends IndexedCollection<T> {
        ...
        map<M>(mapper: (value: T, index: number, iter: this) => M, context?: any): List<M>;

        flatMap<M>(mapper: (value: T, index: number, iter: this) => ESIterable<M>, context?: any): List<M>;
    ...
    declare class Map<K, V> extends KeyedCollection<K, V> {
        ...
        merge<K_, V_>(...iterables: (ESIterable<[K_, V_]> | { [key: K_]: V_ })[]): Map<K | K_, V | V_>;
        ...
        mergeDeep<K_, V_>(...iterables: (ESIterable<[K_, V_]> | { [key: K_]: V_ })[]): Map<K | K_, V | V_>;
        ...
        updateIn(keyPath: ESIterable<any>, notSetValue: any, updater: (value: any) => any): Map<K, V>;
        updateIn(keyPath: ESIterable<any>, updater: (value: any) => any): Map<K, V>;
        ...
        map<V_>(mapper: (value: V, key: K, iter: this) => V_, context?: any): Map<K, V_>;

        flatMap<K_, V_>(mapper: (value: V, key: K, iter: this) => ESIterable<[K_, V_]>, context?: any): Map<K_, V_>;

        flip(): Map<V, K>;

        mapKeys<K_>(mapper: (key: K, value: V, iter: this) => K_, context?: any): Map<K_, V>;
    ...
    declare class OrderedMap<K, V> extends KeyedCollection<K, V> {
        ...
        merge<K_, V_>(...iterables: (ESIterable<[K_, V_]> | { [key: K_]: V_ })[]): OrderedMap<K | K_, V | V_>;
        ...
        mergeDeep<K_, V_>(...iterables: (ESIterable<[K_, V_]> | { [key: K_]: V_ })[]): OrderedMap<K | K_, V | V_>;
        ...
        updateIn(keyPath: ESIterable<any>, notSetValue: any, updater: (value: any) => any): OrderedMap<K, V>;
        updateIn(keyPath: ESIterable<any>, updater: (value: any) => any): OrderedMap<K, V>;

        mergeIn(keyPath: ESIterable<K>, ...iterables: (ESIterable<K> | { [key: string]: any })[]): OrderedMap<K, any>;
        mergeDeepIn(
        ...
        // Overrides that specialize return types
        map<V_>(mapper: (value: V, key: K, iter: this) => V_, context?: any): OrderedMap<K, V_>;
        ...
        mapKeys<K_>(mapper: (key: K, value: V, iter: this) => K_, context?: any): OrderedMap<K_, V>;
    ...
    declare class Set<T> extends SetCollection<T> {
        ...
        map<M>(mapper: (value: T, value: T, iter: this) => M, context?: any): Set<M>;

        flatMap<M>(mapper: (value: T, value: T, iter: this) => ESIterable<M>, context?: any): Set<M>;
    ...
    declare class Stack<T> extends IndexedCollection<T> {
        ...
        map<U>(mapper: (value: T, index: number, iter: this) => U, context?: any): Stack<U>;

        flatMap<U>(mapper: (value: T, index: number, iter: this) => ESIterable<U>, context?: any): Stack<U>;
