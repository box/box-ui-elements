...
const singleFile = new File(['contents'], 'upload_file.txt', {
  type: 'text/plain'
});
const multipleFiles = [new File(['contents'], 'upload_file_1.txt', {
  type: 'text/plain'
}), new File(['contents'], 'upload_file_2.txt', {
  type: 'text/plain'
}), new File(['contents'], 'upload_file_3.txt', {
  type: 'text/plain'
})];
export const basic = {
  play: async ({
...
export default {
  ...
  parameters: {
    msw: {
      handlers: [http.options(`${DEFAULT_HOSTNAME_API}/2.0/files/content`, () => {
...
//# sourceMappingURL=ContentUploader-visual.stories.js.map