...
export const searchEmptyState = {
  ...
  play: async ({
    ...
    const canvas = within(canvasElement);
    const searchBar = canvas.getByRole('searchbox', {
...
export const customActionButtons = {
  args: {
    renderCustomActionButtons: ({
      ...
      type: "button"
    }, "Custom Action (", selectedCount, " items)")
  }
};
export default {
  ...
  parameters: {
    msw: {
      handlers: [http.get(`${DEFAULT_HOSTNAME_API}/2.0/folders/69083462919`, () => {
...
//# sourceMappingURL=ContentPicker-visual.stories.js.map