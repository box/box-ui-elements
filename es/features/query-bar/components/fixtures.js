export const columnForItemName = {
  displayName: 'Name',
  id: '1',
  isShown: true,
  property: 'name',
...
export const columnForItemLastUpdated = {
...
export const columnWithEnumType = {
...
export const columnForDateType = {
...
export const columnWithMultiEnumType = {
  displayName: 'Offices',
  id: '5',
  isShown: true,
  property: 'offices',
...
export const columnWithFloatType = {
  displayName: 'Count',
  id: '6',
  isShown: true,
  property: 'count',
...
export const columnWithNumberType = {
  displayName: 'Assets',
  id: '8',
  isShown: true,
  property: 'assets',
...
const metadataColumns = [columnWithEnumType, columnWithMultiEnumType];
