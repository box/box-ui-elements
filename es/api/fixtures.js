...
import { FILE_ACTIVITY_TYPE_ANNOTATION, FILE_ACTIVITY_TYPE_COMMENT, FILE_ACTIVITY_TYPE_TASK, FILE_ACTIVITY_TYPE_VERSION, TASK_NEW_NOT_STARTED } from '../constants';
...
export const fileActivities = [{
  ...
  source: {
    versions: fileActivitiesVersion
  }
}, {
  ...
  source: {
    task: _objectSpread(_objectSpread({}, task), {}, {
      assigned_to: _objectSpread(_objectSpread({}, task.assigned_to), {}, {
        entries: [{
          id: '1',
          target: {
            name: 'Beyonce',
