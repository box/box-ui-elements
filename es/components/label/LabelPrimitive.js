const _excluded = ["children", "className", "labelContent", "labelElProps"];
...
const LabelPrimitive = _ref => {
  ...
  return /*#__PURE__*/React.createElement("label", labelElProps, /*#__PURE__*/React.createElement("span", _extends({
