...
declare const itemIconTable: {
    ...
    boxcanvas: (props: SVGProps) => React.JSX.Element;
    ...
    'docuworks-binder': (props: SVGProps) => React.JSX.Element;
    'docuworks-file': (props: SVGProps) => React.JSX.Element;
...
declare const ItemIcon: ({ className, dimension, iconType, title }: ItemIconProps) => React.JSX.Element;
